# Generated by Django 3.1.3 on 2020-12-31 21:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.CharField(blank=True, max_length=80, null=True)),
                ...
                ('awards', models.CharField(blank=True, max_length=1500, null=True)),
                ('amazon_redirect_link', models.CharField(max_length=250)),
                ('recommended_books', models.CharField(max_length=250)),
                ('books_in_series', models.CharField(blank=True, max_length=250, null=True)),
