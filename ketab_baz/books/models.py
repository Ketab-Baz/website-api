...
class Book(models.Model):
    ...
    series = models.CharField(max_length=80, blank=True, null=True)
    ...
    genre_and_votes = models.CharField(max_length=2000)
    isbn = models.CharField(max_length=50)
    isbn13 = models.CharField(max_length=50)
    awards = models.CharField(max_length=1500, blank=True, null=True)
    amazon_redirect_link = models.CharField(max_length=250)
    recommended_books = models.CharField(max_length=250)
    books_in_series = models.CharField(max_length=250, blank=True, null=True)
